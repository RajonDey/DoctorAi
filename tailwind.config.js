...
export default {
  ...
  theme: {
    extend: {
      backgroundImage: {
        "abstract-image": "url('./src/assets/img/bg.png')",
      },
    },
    fontFamily: {
  ...
  daisyui: {
    themes: ["light", "dark", "night"], // true: all themes | false: only light + dark | array: specific themes like this ["light", "dark", "cupcake"]
