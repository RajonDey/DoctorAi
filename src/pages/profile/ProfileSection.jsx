...
const HeroSection = () => {
  return (
    <section className="relative block h-[325px]">
      <div
        className="absolute -top-14 w-full h-full bg-center bg-cover"
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1556139943-4bdca53adf1e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80')",
        }}
      >
        <span
          id="blackOverlay"
              ...
              <div className="flex flex-wrap justify-center">
                <div className="w-full  px-4">
                  <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                    Hello there! I'm {user?.displayName}, user of this DoctorAi.
                  </p>
                </div>
              </div>
            </div>
