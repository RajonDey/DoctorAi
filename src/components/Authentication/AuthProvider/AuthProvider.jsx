    ...
    <div>
      ...
      <div className="flex  justify-center ">
        <button
          ...
          className="w-2/12 tracking-wide btn-neutral  btn h-10 btn-lg my-1 bg-transparent text-black text-xl hover:bg-transparent"
        >
          <BsGoogle></BsGoogle>
        </button>
        <button
          onClick={handlegithublogin}
          className="w-2/12 tracking-wide btn-neutral  btn h-10 btn-lg my-1 bg-transparent text-black text-2xl hover:bg-transparent"
        >
          <BsGithub></BsGithub>
        </button>
      </div>
