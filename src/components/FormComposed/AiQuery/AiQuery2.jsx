  ...
  return (
    <div style={{ fontFamily: "'Poppins', sans-serrif" }}>
      ...
      <div className="flex-1 md:px-[5%] justify-between flex flex-col w-[95vw] lg:w-[70vw] py-2 min-h-screen max-h-screen">
        ...
        <div className="px-6 pt-4 mb-4 sm:mb-0 pb-6">
          <div className="relative flex">
            ...
            <div className="w-20 h-full max-h-20 items-stretch inset-y-0 flex">
              <button
                type="button"
                className={`send-button inline-flex h-[50px] backdrop-blur-sm border border-grey-dark focus:bg-transparent-white/20 bg-transparent-dark items-center justify-center rounded-l-lg px-4 py-3 transition duration-500 ease-in-out text-dark bg-blue-500 hover:bg-blue-400 focus:outline-none ${
