              ...
              >
                ...
                >
                  ...
                  <h2 className="text-sm font-medium mt-1 w-[210px] h-[15px]">
                    {session?.message?.length > 25
                      ? session?.message.substring(0, 25) + "..."
                      : session?.message}
                  </h2>
                  <div className="flex mt-4 items-center justify-between flex-row flex-wrap ">
                    {session?.subjectSelection && (
                      <div className="flex gap-1 text-left">
                        <span className="whitespace-nowrap rounded-full w-[120px] lg:w-[150px]  overflow-hidden px-2 py-1 text-xs text-dark pl-4">
                          {session?.subjectSelection}
                        </span>
                      </div>
                    )}
